...
public class PeopleAdapter extends ExpandableRecyclerAdapter<PeopleAdapter.PeopleListItem> {
    ...
    public class HeaderViewHolder extends ExpandableRecyclerAdapter.HeaderViewHolder {
        ...
        public HeaderViewHolder(View view) {
            super(view, (ImageView) view.findViewById(R.id.iv_thumb));

            name = (TextView) view.findViewById(R.id.list_txt);
        }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case TYPE_HEADER:
                return new HeaderViewHolder(inflate(R.layout.tab5explore_list_layout, parent));
            case TYPE_PERSON:
            default:
                return new PersonViewHolder(inflate(R.layout.tab5explore_list_layout, parent));
        }
    }
